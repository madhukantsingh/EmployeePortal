...
const {id} = useParams()
  const loadUsers = async () => {
    const result = await axios.get(`http://127.0.0.1:8000/leavehistory/${id}`);
...
console.log(users,"this is users")
  return (
    <div className="sidebarle">
       <SideBar/>
          <center>
        <h1 className="lh2">leave history</h1>
...
//       <h1 style={{backgroundColor: "#483d8b"}}>Appraisal</h1>
...
//                     <Column field="name" header="Leave id" filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
//                     <Column header="employee id" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by year" />
//                     <Column header="Name" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
//                     <Column header="Approver" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
//                     <Column header="leave_type" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
//                     <Column header="leave_reason" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
//                     <Column header="start date" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
//                     <Column header="end date" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
//                     <Column header="status" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by Qulifier" />
